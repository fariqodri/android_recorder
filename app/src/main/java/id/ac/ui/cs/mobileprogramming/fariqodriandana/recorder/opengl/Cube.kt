...
class Cube {
    ...
    internal var colorcyan = MyColor.cyan()
    internal var colorblue = MyColor.blue()
    internal var colorred = MyColor.red()
    internal var colorgray = MyColor.gray()
    internal var colorgreen = MyColor.green()
    internal var coloryellow = MyColor.yellow()

    //vertex shader code
    internal var vShaderStr = (
            "#version 300 es 			  \n"
